...
import com.xiaowang.shopping.base.utils.HttpUtils;
import lombok.extern.slf4j.Slf4j;
import org.apache.http.util.EntityUtils;

import java.util.Map;

import static com.xiaowang.shopping.base.constant.Constant.Http;
...
public class AuthServiceImpl implements AuthService {
  ...
  public boolean checkAuth(String realName, String idCard) {
    String method = Http.METHOD_POST;
    ...
    try {
      ...
      if ((Integer) resultMap.get(Http.PARAM_STATE) == 1) {
        return true;
      }
    } catch (Exception e) {
